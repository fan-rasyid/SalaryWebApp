...
@WebServlet(urlPatterns = {"/getDataJob"})
public class GetDataJob extends HttpServlet {
    @Override
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    writer.println("\n" +
                            ...
                            "                  <td>"+ id +"</td>\n" +
                            "                  <td>"+ job_title +"</td>\n" +
                            "<td><a href=editDataJob?job_id=" + id +"&job_title="+job_title.replace(" ", "%20")+">Edit</a></td>"+
                            "                </tr>\n" );
                }
